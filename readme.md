...
## Overview
This repository contains a **secure, backend-focused fintech trading system** implemented using **FastAPI**, **SQLAlchemy**, **Alembic**, and **MySQL**.

The application supports authenticated trade execution, FIFO-based accounting, portfolio valuation, and a rule-driven risk engine. It is designed to emphasise **security, correctness, and auditability**, aligning with real-world financial system expectations.
...
- Portfolio aggregation with realised and unrealised P&L
...
Environment variables are configured (database URL, JWT secret)
...
v1.4.0 – FIFO lot accounting and realised P&L
